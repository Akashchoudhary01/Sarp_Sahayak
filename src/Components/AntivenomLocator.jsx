  ...
  return (
    <div className="flex flex-col h-screen">
      <div className="relative bg-gray-200 h-64 flex items-center justify-center border-b-2 border-gray-300">
        ...
        <div className="absolute bottom-16 right-20 z-20 animate-pulse" style={{ animationDelay: '0.5s' }}>
          <MapPin size={32} className="text-red-600 drop-shadow-lg" fill="#DC2626" />
        </div>
        <div className="absolute top-32 right-12 z-20 animate-pulse" style={{ animationDelay: '1s' }}>
          <MapPin size={32} className="text-red-600 drop-shadow-lg" fill="#DC2626" />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 pb-24">
        ...
        <div className="mt-6 bg-red-600 text-white rounded-lg p-4 text-center sticky bottom-0">
