        ...
        <div className="bg-gray-100 rounded-lg p-4">
          ...
          {!analyzing && aiResult && !error && (
            <div className={`mt-4 p-4 rounded-lg 
                ${aiResult.venomous_level.includes('Highly') ? 'bg-red-50 border-2 border-red-400' : 'bg-green-50 border-2 border-green-400'}`}
            >
      ...
      <div className="space-y-4">
        <label className="block">
          <input
            ...
            onClick={(e) => { e.target.value = null; setAiResult(null); setError(null); }} 
          />
        ...
        <button 
          ...
          onClick={() => { setSelectedImage(null); setAiResult(null); setError(null); }}
        >
