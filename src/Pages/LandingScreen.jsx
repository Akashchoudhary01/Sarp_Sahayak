...
export default function LandingScreen({ onSelectMode, language, onToggleLanguage }) {
  return (
        ...
        <div className="space-y-6 max-w-md mx-auto w-full">
          ...
          >
            ...
            <div className="text-sm font-normal opacity-90">
              {language === 'en' ? 'Emergency Response Mode' : 'आपातकालीन प्रतिक्रिया मोड'}
            </div>
          </button>
          ...
          >
            ...
            <div className="text-sm font-normal opacity-90">
              {language === 'en' ? 'Medical Professional Mode' : 'चिकित्सा पेशेवर मोड'}
            </div>
          </button>
        </div>
