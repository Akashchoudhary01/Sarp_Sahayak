...
export default function DoctorModeFlow({ language, onBack }) {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            {/* Header */}
            <div className="sticky top-0 bg-red-600 text-white px-4 py-4 flex items-center shadow-lg">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6 pb-20">
                {/* 1. Snake Type Selector */}
                <div>
                    <h2 className="text-lg font-bold mb-3 text-gray-800">
                        {language === 'en' ? '1. Identify Biting Snake (If Known)' : '1. काटने वाले साँप की पहचान करें (यदि ज्ञात हो)'}
                    </h2>
                    <select
                        value={snakeType}
                ...
                <div>
                    <h2 className="text-lg font-bold mb-3 text-gray-800">
                        {language === 'en' ? '2. Patient Symptoms Checklist' : '2. रोगी के लक्षणों की जाँच सूची'}
                    </h2>
